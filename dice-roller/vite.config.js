...
function dynamicDicePlugin() {
  const wireframes = {
    d4: `<path d="M50 20 L80 75 L20 75 Z" fill="none" stroke="#888888" stroke-width="3" stroke-linejoin="round"/>
  <path d="M50 20 L50 75 M50 20 L20 75 M50 20 L80 75" fill="none" stroke="#888888" stroke-width="2" stroke-opacity="0.5"/>
  ...
  <line x1="50" y1="50" x2="80" y2="75" stroke="#888888" stroke-width="3" />`,
    ...
    d6: `<path d="M50 25 L80 40 V65 L50 80 L20 65 V40 Z" fill="none" stroke="#888888" stroke-width="3" stroke-linejoin="round"/>
  <path d="M50 25 V52 L80 40 M50 52 L20 40" fill="none" stroke="#888888" stroke-width="3" stroke-linejoin="round"/>`,

    d8: `<path d="M50 15 L80 50 L50 85 L20 50 Z" fill="none" stroke="#888888" stroke-width="3" stroke-linejoin="round"/>
  <path d="M20 50 L50 40 L80 50 M50 15 V85" fill="none" stroke="#888888" stroke-width="3" stroke-linejoin="round"/>`,

    d10: `<path d="M50 15 L75 35 L70 65 L50 80 L30 65 L25 35 Z" fill="none" stroke="#888888" stroke-width="3" stroke-linejoin="round"/>
  <path d="M25 35 L50 45 L75 35 M30 65 L50 55 L70 65 M50 15 V80" fill="none" stroke="#888888" stroke-width="2" stroke-linejoin="round"/>`,

    d12: `<path d="M50 20 L78 35 L78 65 L50 80 L22 65 L22 35 Z" fill="none" stroke="#888888" stroke-width="3" stroke-linejoin="round"/>
  ...
  <path d="M50 20 V35 M78 35 L68 48 M78 65 L61 70 M50 80 V70 M22 65 L39 70 M22 35 L32 48" fill="none" stroke="#888888" stroke-width="2"/>`,
    ...
    d20: `<path d="M50 15 L85 35 V65 L50 85 L15 65 V35 Z" fill="none" stroke="#888888" stroke-width="3" stroke-linejoin="round"/>
  <path d="M50 35 L75 60 L25 60 Z" fill="none" stroke="#888888" stroke-width="2" stroke-linejoin="round"/>
  <path d="M50 15 L50 35 M85 35 L75 60 M85 65 L75 60 M50 85 L75 60 M50 85 L25 60 M15 65 L25 60 M15 35 L25 60 M50 15 L75 60 M50 15 L25 60" fill="none" stroke="#888888" stroke-width="1.5" stroke-opacity="0.8"/>`,

    d100: `<path d="M50 15 L75 35 L70 65 L50 80 L30 65 L25 35 Z" fill="none" stroke="#888888" stroke-width="3" stroke-linejoin="round"/>
  <path d="M25 35 L50 45 L75 35 M30 65 L50 55 L70 65 M50 15 V80" fill="none" stroke="#888888" stroke-width="2" stroke-linejoin="round"/>`
  };
  ...
  <rect x="5" y="5" width="90" height="90" rx="15" fill="#1a1a1a" stroke="${color}" stroke-width="4"/>
  ${wireframe}
